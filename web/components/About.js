...
const About = ({company, businesses, briefs, handleDown, carouselRef}) => {
	return (
		<>
			<section className="about-wrap">
				...
				<article className="rept">
					<div className="box face-wrap">
						<img
                            className="face"
                            src={process.env.NEXT_PUBLIC_IMAGE_SERVER + "2.png"}
                            alt="face"
					...
					<div className="flex-wrap">
						<div className="box name-wrap">
							<h3 className="name">{company.president}</h3>
						</div>
						<div className="box text-wrap">
						{company.comment.map((text, index) => (
					...
					>
						...
						<div className="box carousel-item" key={index}>
							<img
                                ...
                                src={process.env.NEXT_PUBLIC_IMAGE_SERVER + business.image}
                                alt="item"
                                onError={(e) => {e.target.src = process.env.NEXT_PUBLIC_ERROR_IMAGE}}
                            />
...
const style = css`
	...
	.face-wrap { width: calc(30vw - 30px); height: calc(30vw - 30px); padding: 15px; }
	.face { width: 100%; height: 100%; border-radius: 7px; }
